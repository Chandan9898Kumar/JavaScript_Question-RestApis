(Problem Solving ):
Question .1. Given an array of objects [{banana: 5, apples:5}, {pear: 6}, {apples: 5}, {banana:2}], return an object with the sum of all the fruits   .
...
---------------------------------------------------------------------------------------------------------
// question .2. -  count on the basis of name.
...
//  question 6.  find smallest word by length in an array.if length match then compare by ascii character.
...
//  Question .7.   find 2nd largest Number.
...
Question . 8 . Group book objects by genre:
...
Question  .9.   categorize numbers into odd and even groups:
